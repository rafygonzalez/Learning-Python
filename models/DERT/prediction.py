...
class Detr(pl.LightningModule):
     ...
     def __init__(self):
         ...
         self.model = DetrForObjectDetection.from_pretrained("facebook/detr-resnet-50", num_labels = 43, ignore_mismatched_sizes=True)
...
def rescale_bboxes(out_bbox, size):
    img_w, img_h = size
    #b = ops.box_convert(out_bbox, in_fmt='cxcywh', out_fmt='xyxy')
...
if __name__ == '__main__':
    ...
    model_path = get_final_path(1, ['DERT','model', 'model.ckpt'])
    print(model_path)
